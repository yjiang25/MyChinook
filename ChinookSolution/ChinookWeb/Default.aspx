...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">The Chinook Music Store provides customers to create custom playlists from a wide selection 
                       of music titles. Titles can be selected by Artist , Genre, Album, or Media Type. 
        </p>
        <p>Future features will include movies and other video type, and the ability to request medio 
